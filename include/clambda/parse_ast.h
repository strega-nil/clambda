...
typedef void parse_ast_var_match_t (struct parse_ast_var *, void *);
typedef void parse_ast_abs_match_t (struct parse_ast_abs *, void *);
typedef void parse_ast_app_match_t (struct parse_ast_app *, void *);
...
void parse_ast_match (struct parse_ast const *, void const *,
                      parse_ast_var_match_t *, parse_ast_abs_match_t *,
                      parse_ast_app_match_t *);
